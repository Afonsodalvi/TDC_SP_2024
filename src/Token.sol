...
pragma solidity >=0.5.0 <0.9.0; // Token ERC20 TDC para entendimento
//---------------------------------------------------------------
...
interface ERC20Interface {
    ...
    function allowance(address tokenOwner, address spender) external view returns (uint256 remaining); //Permição do criador do token para o endereço que irá gastar o determinado token e a quantidade delimitada
    ...
    function transferFrom(address from, address to, uint256 tokens) external returns (bool sucess); //treanferencia de um endereço para o outro os valores dos tokens, com função externa e retorna booliana verdadeira ou falsa
...
contract TDC is
    ERC20Interface // vamos definir as variáveis estáveis de um ERC20
{
    string public name = "TDC_token"; //O nome é igual a criptos, cada token ou criptomoeda tem seu próprio símbolo, como BTC para bitcoin ou éter
    string public symbol = "TDC"; // simbolo do seu token/cripto
    ...
    address public owner; // endereço do dono inicial do token
    ...
    constructor() {
        ...
        owner = msg.sender; // o criador será que fez o deploy
        balances[owner] = totalSupply; //o saldo relativo aos tokens criados vai para a conta do criador dos tokens, ou seja, ele que terá os tokens inicialmente e poderá vender ou distribuir.
    }
    ...
    function approve(address spender, uint256 tokens) public override returns (bool success) {
        //função de aprovar a autorização de credito dos tokens para o gastador
